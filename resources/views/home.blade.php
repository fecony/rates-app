...
<div class="relative min-h-screen bg-white bg-center sm:flex sm:justify-center sm:items-center bg-dots selection:bg-indigo-500 selection:text-white text-slate-500 dark:text-slate-400 dark:bg-slate-900">
    <div class="container w-full p-6 mx-auto lg:p-8">
        <div class="flex justify-center">
            <x-logo class="w-auto h-16 text-indigo-600 bg-white dark:bg-slate-900" />
        </div>
